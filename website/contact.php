...
// flag to indicate which method to use. If POST set it to 1
...
if (!$errors) {
	...
	$to = 'arkaniteonvita@gmail.com';
	// sender - from the form
	$from = $name . ' <' . $email . '>';
	// subject and the html message
	$subject = 'VHBB - Message from ' . $name;	
...
// Simple mail function with HTML header (should work fine)
