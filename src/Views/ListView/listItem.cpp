...
ListItem::ListItem(Homebrew hb)
    ...
    , img_itm_panel(CachedTexture(&_binary_assets_spr_img_itm_panel_png_start))
    , img_itm_panel_highlight(CachedTexture(&_binary_assets_spr_img_itm_panel_highlight_png_start))
    , img_icon_(CachedTexture(std::string(ICONS_FOLDER "/") + hb.icon))
    , img_itm_label_game(CachedTexture(&_binary_assets_spr_img_itm_label_game_png_start))
    , img_itm_label_port(CachedTexture(&_binary_assets_spr_img_itm_label_port_png_start))
    , img_itm_label_emu(CachedTexture(&_binary_assets_spr_img_itm_label_emu_png_start))
    , img_itm_label_util(CachedTexture(&_binary_assets_spr_img_itm_label_util_png_start))
